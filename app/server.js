...
/** @constructor */
function $c_Lorg_dractec_ftetris_node_ScoreServer$() {
  $c_O.call(this)
}
$c_Lorg_dractec_ftetris_node_ScoreServer$.prototype = new $h_O();
$c_Lorg_dractec_ftetris_node_ScoreServer$.prototype.constructor = $c_Lorg_dractec_ftetris_node_ScoreServer$;
/** @constructor */
function $h_Lorg_dractec_ftetris_node_ScoreServer$() {
  /*<skip>*/
}
$h_Lorg_dractec_ftetris_node_ScoreServer$.prototype = $c_Lorg_dractec_ftetris_node_ScoreServer$.prototype;
$c_Lorg_dractec_ftetris_node_ScoreServer$.prototype.init___ = (function() {
  return this
});
$c_Lorg_dractec_ftetris_node_ScoreServer$.prototype.main__AT__V = (function(args) {
  var app = $i_express();
  var res = $as_T($i_path.resolve());
  var __dirname = ($m_sjsr_RuntimeString$().endsWith__T__T__Z(res, "/app") ? res : (res + "/app"));
  var a = $i_express["static"]((__dirname + "/public"));
  app.use("/public", a);
  var server = app.get("/", (function($this, __dirname$1) {
    return (function(x$1$2, resp$2) {
      resp$2.sendFile((__dirname$1 + "/views/index.html"))
    })
  })(this, __dirname)).get("/scores/:name", (function(this$2$1) {
    return (function(req$2, resp$3$2) {
      var jsx$2 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Got request ", " with origUrl=", " and "])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([req$2, $as_T(req$2.originalUrl)]));
      var jsx$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["name=", ""]));
      var dict = req$2.params;
      if ((!$uZ($m_sjs_js_WrappedDictionary$Cache$().safeHasOwnProperty$1.call(dict, "name")))) {
        throw new $c_ju_NoSuchElementException().init___T("key not found: name")
      };
      var x = (("" + jsx$2) + jsx$1.s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([dict.name])));
      ...
      var thiz$1 = $as_T(req$2.originalUrl);
      var thiz = $as_T(req$2.originalUrl);
      var beginIndex = ((8 + $uI(thiz.indexOf("/scores/"))) | 0);
      var s = $as_T(thiz$1.substring(beginIndex));
      resp$3$2.send(s)
    })
  })(this));
  server.listen(3000, (function(this$3$1, port, __dirname$2) {
    return (function() {
      var x$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Server listening on port ", " in dir ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([port, __dirname$2]));
...
var $d_Lorg_dractec_ftetris_node_ScoreServer$ = new $TypeData().initClass({
  Lorg_dractec_ftetris_node_ScoreServer$: 0
}, false, "org.dractec.ftetris.node.ScoreServer$", {
  Lorg_dractec_ftetris_node_ScoreServer$: 1,
  O: 1
});
$c_Lorg_dractec_ftetris_node_ScoreServer$.prototype.$classData = $d_Lorg_dractec_ftetris_node_ScoreServer$;
var $n_Lorg_dractec_ftetris_node_ScoreServer$ = (void 0);
function $m_Lorg_dractec_ftetris_node_ScoreServer$() {
  if ((!$n_Lorg_dractec_ftetris_node_ScoreServer$)) {
    $n_Lorg_dractec_ftetris_node_ScoreServer$ = new $c_Lorg_dractec_ftetris_node_ScoreServer$().init___()
  };
  return $n_Lorg_dractec_ftetris_node_ScoreServer$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$m_Lorg_dractec_ftetris_node_ScoreServer$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
//# sourceMappingURL=backend-fastopt.js.map
